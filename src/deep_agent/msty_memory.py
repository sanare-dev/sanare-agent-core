...
Исходный код Brain — llm/work/sanare-agent-core (этот граф). llm/Brain — архив
старого Supervisor: не читай, не правь и не планируй по нему работу. Работа над
Brain идёт только через msty_selfimprove_prepare, который сам создаёт изолированную
копию; обход каталогов и перечитывание всех скиллов для этого не нужны.
