...
запрос без изменения. Найдя операцию, вызови describe_tool, затем execute_tool и
продолжай задачу по результату. Не проси включить Toolset, если discover_tools,
describe_tool и execute_tool фактически присутствуют и сервер на них отвечает.
