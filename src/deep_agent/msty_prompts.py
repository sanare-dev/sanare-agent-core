...
исполнение доступно, исправь, выполни readback и только после этого отчитайся. Не
перекладывай обычный следующий шаг на владельца и не проси включить уже переданный
Toolset. Заявить точный внешний блокер можно только после фактической попытки
...
например «search sites», «site details», «cron», «activity logs» или «wp-cli».
