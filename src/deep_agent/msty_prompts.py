...
(Store, reference_only). Перед работой ищи в ней похожее: инструментом поиска
памяти, если он есть в переданных схемах, иначе native_grep/native_glob по /memories/. После существенной
